 ...
 * @author Carlos Clark
 */
public class FrmEditarMantenimiento extends javax.swing.JFrame {

    public FrmEditarMantenimiento() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Mantenimiento");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEditarMantenimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmEditarMantenimiento().setVisible(true);
            }
        });
    }
