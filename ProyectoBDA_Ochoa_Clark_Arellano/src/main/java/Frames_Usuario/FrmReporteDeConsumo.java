 ...
 * @author aleja
 */
public class FrmReporteDeConsumo extends javax.swing.JFrame {

    public FrmReporteDeConsumo() {
        initComponents();
        
        // PlaceHolders para el TXT Búsqueda
        txtBusqueda.setText("Buscar por Instalación...");
        txtBusqueda.setForeground(Color.GRAY);
        txtBusqueda.addFocusListener(new java.awt.event.FocusAdapter() {
        @Override
        public void focusGained(java.awt.event.FocusEvent evt) {
            if (txtBusqueda.getText().equals("Buscar por Instalación...")) {
                txtBusqueda.setText("");
        ...
        // Aqui termina el PlaceHolder del TXT
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Reporte de Consumo");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(24, 24, 24)
                        .addComponent(txtBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE, 371, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmReporteDeConsumo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmReporteDeConsumo().setVisible(true);
            }
        });
    }
